...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content">
        ...
        <div class="row m-3">
            <div align="center">
                <asp:Button ID="btnRegistrar" runat="server" CssClass="btn btn-primary me-4" Width="200px" Text="Registrar" OnClick="btnRegistrar_Click" />
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-tittle" id="myModalLabel">Actualizar Registro</h4>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" id="btnActualizar" data-target="#imodal" data-toggle="modal">Actualizar</button>
                    </div>
                </div>
            </div>
        </div>
